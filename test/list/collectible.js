...
_.each(_.sortBy(collectibleObjs, 'name'), obj => {
  ...
  var rarity = (obj.properties ? obj.properties.rarity : obj.rarity) || 'basic';
  console.log(_.padStart(obj.name, 35), '\t|\t', _.padStart(rarity), '\t|\t', _.padStart(storyline, 25), '\t|\t', obj.origin);
});
